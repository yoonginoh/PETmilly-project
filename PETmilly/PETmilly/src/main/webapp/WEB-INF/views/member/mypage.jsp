...
<body>
        ...
        <section class="page-section" id="contact" style="margin-top: 150px">
            <div class="container">
                ...
                <h2 class="text display-3 mb-5" style="color: #ff4800; text-align: center;">mypage</h2>
                <!-- Icon Divider-->
                <div class="divider-custom">
                    ...
                    <div class="divider-custom-icon">
                    	<c:if test="${sessionScope.login.profileImg == null }">
	                    	<img src="${pageContext.request.contextPath}/img/non.png" id="myImage" class="rounded-circle img-thumbnail shadow-sm"
